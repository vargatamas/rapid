<h1>Globális Források módosítása</h1>
{if="'' != $error"}
...
<form method="post" action="{$baseURL}administrator/globalsources/save" class="form-horizontal" role="form">
                ...
                {if="'' != $sourceContent.javascripts.0"}
                    {loop="sourceContent.javascripts"}
                        <div class="input-group">
                            ...
                            <span class="input-group-btn"><button class="btn btn-danger remove-source" type="button">Eltávolítás</button></span>
                        </div>
                        <br />
                    {/loop}
                {else}
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            ...
            <button type="button" class="btn btn-default add-source"><i class="glyphicon glyphicon-plus"></i>&nbsp;Új CSS fájl</button>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-10">
            ...
            <button type="button" class="btn btn-default add-source"><i class="glyphicon glyphicon-plus"></i>&nbsp;Új LESS fájl</button>
        </div>
    </div>
    {if="'' != $last_modified"}
        <div class="form-group">
