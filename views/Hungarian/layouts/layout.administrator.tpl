    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            {if="'' != $navBeans"}
                <li class="dropdown{if="isset($menu.beanActive) || isset($menu.newBeanActive) || isset($menu.executeActive)"} active{/if}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li{$menu.executeActive?' class="active"':''}><a href="{$baseURL}administrator/beans/execute">SQL futtatás</a></li>
                    </ul>
                </li>
            {/if}
        ...
        {if="$USER"}
            <form method="post" action="/administrator" class="navbar-form navbar-right">
                ...
                <button type="submit" class="btn btn-default">Kilépés <i class="fa fa-sign-out"></i></button>&nbsp;&nbsp;&nbsp;
            </form>
        {/if}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="{$baseURL}administrator/" class="btn btn-default pull-left"><i class="fa fa-home"></i> Köszöntő oldal</a>
        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-ban"></i> Bezárás</button>
        {if="isset($currentVersion)"}
            <a href="{$baseURL}administrator/update" class="btn btn-success"><i class="fa fa-cogs"></i> Frissítés erre: {$currentVersion}</a>
        {/if}
      </div>
    </div>
  </div>
